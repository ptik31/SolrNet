...
namespace SolrNet.Cloud.Tests
{
    public class FakeProvider : ISolrCloudStateProvider, ISolrOperationsProvider
    {
        ...
        public SolrCloudState GetCloudState() {
            var replica1 = new SolrCloudReplica(true, true, "leader1", "http://localhost:8983/solr1/collection1", ReplicaType.NRT);
            var replica2 = new SolrCloudReplica(true, false, "replica1", "http://localhost:8983/solr2/collection1", ReplicaType.NRT);
            var replica3 = new SolrCloudReplica(false, false, "replica2", "http://localhost:8983/solr3/collection1", ReplicaType.NRT);
            var replica4 = new SolrCloudReplica(true, true, "leader2", "http://localhost:8983/solr2/collection2", ReplicaType.NRT);
            var replica5 = new SolrCloudReplica(true, false, "replica3", "http://localhost:8983/solr1/collection2", ReplicaType.NRT);
            var replica6 = new SolrCloudReplica(false, false, "replica4", "http://localhost:8983/solr3/collection2", ReplicaType.NRT);
